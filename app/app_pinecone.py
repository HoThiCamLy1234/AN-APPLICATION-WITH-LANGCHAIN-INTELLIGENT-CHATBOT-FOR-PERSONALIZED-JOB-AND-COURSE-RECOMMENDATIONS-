...
async def initialize_bot():
    ...
    welcome_message.content = (
        "Hi, Welcome to Chat With Documents using OpenAI and LangChain."
    )
    ...
    def get_pdf_text(url_pdf_docs):
        pdf_reader = PdfReader(url_pdf_docs)
    ...
    Nếu bạn không biết câu trả lời, hãy nói rằng bạn không biết, không cố gắng bịa chuyện.
    LUÔN LUÔN trả về phần "NGUỒN THAM KHẢO" trong câu trả lời của bạn.
